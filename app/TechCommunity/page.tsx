    ...
    <section className="text-gray-600 dark:text-gray-200 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap w-full mb-20">
          ...
          <p className="lg:w-1/2 w-full text-xl leading-relaxed text-gray-500 dark:text-gray-100">
            Explore Tech Communities across India at one platform, where you can
            communicate with others, get mentorship, and learn more about
            technology.
          </p>
        </div>
        <div className="flex flex-wrap -m-4">
          ...
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <h2 className="text-lg dark:text-white font-medium title-font mb-2">
